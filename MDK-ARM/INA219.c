...
void Write16(INA219_t *ina219, uint8_t Register, uint16_t Value)
{
	...
	HAL_I2C_Mem_Write(ina219->ina219_i2c, (0x40<<1), Register, 1, (uint8_t*)addr, 2, 1000);
}
...
void INA219_setCalibration_32V_1A(INA219_t *ina219)
{
	...
	ina219_powerMultiplier_mW = 1; // Power LSB = 800uW per bit
